...
export class AuthManagerService {
  ...
  private sellerloginUrl: string = "http://localhost:4040/api/auth/signin";  // url for logging in
  private customerloginUrl: string = "http://localhost:4040/api/auth/signin";
  private sellerRegUrl: string = "http://localhost:4040/api/auth/signup";
  private sellerUpdateUrl: string = "http://localhost:4040/EKart/SellerAPI/modifySellerDetails";  //update seller's account
