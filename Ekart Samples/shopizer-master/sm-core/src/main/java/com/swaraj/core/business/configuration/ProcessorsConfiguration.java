...
import com.swaraj.core.business.modules.order.OrderProcessor;
import com.swaraj.core.business.modules.order.total.PromoCodeCalculatorModule;
import com.swaraj.core.modules.order.total.OrderTotalPostProcessorModule;
import com.swaraj.core.business.modules.cart.ShoppingCartProcessor;
...
public class ProcessorsConfiguration {
	...
	public List<OrderTotalPostProcessorModule> orderTotalsPostProcessors() {
		...
		///processors.add(new com.swaraj.core.business.modules.order.total.ManufacturerShippingCodeOrderTotalModuleImpl());
