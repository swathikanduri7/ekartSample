...
import com.swaraj.core.modules.constants.Constants;
...
public class ShippingDecisionPreProcessorImpl implements ShippingQuotePrePostProcessModule {
	...
	public void prePostProcessShippingQuotes(
		...
		KieSession kieSession=droolsBeanFactory.getKieSession(ResourceFactory.newClassPathResource("com/swaraj/drools/rules/ShippingDecision.drl"));
