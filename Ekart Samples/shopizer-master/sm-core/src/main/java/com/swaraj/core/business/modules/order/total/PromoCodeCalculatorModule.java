package com.swaraj.core.business.modules.order.total;
...
import com.swaraj.core.business.configuration.DroolsBeanFactory;
...
public class PromoCodeCalculatorModule implements OrderTotalPostProcessorModule {
	...
	public OrderTotal caculateProductPiceVariation(OrderSummary summary, ShoppingCartItem shoppingCartItem,
		...
		KieSession kieSession=droolsBeanFactory.getKieSession(ResourceFactory.newClassPathResource("com/swaraj/drools/rules/PromoCoupon.drl"));
