package com.swaraj.test.shop.integration.product;
...
import com.swaraj.core.model.catalog.product.attribute.ProductOptionType;
...
import com.swaraj.shop.model.catalog.manufacturer.Manufacturer;
import com.swaraj.shop.model.catalog.product.PersistableProduct;
import com.swaraj.shop.model.catalog.product.PersistableProductPrice;
...
public class ProductManagementAPIIntegrationTest extends ServicesTestSupport {
	...
	public void createProductWithCategory() throws Exception {
		...
		specifications.setManufacturer(
				com.swaraj.core.model.catalog.product.manufacturer.Manufacturer.DEFAULT_MANUFACTURER);
