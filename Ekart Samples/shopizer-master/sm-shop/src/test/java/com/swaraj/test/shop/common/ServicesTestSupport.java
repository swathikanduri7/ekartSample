...
import com.swaraj.shop.model.catalog.manufacturer.ManufacturerDescription;
...
import com.swaraj.shop.model.catalog.product.ProductDescription;
...
import com.swaraj.shop.store.security.AuthenticationRequest;
import com.swaraj.shop.store.security.AuthenticationResponse;
...
public class ServicesTestSupport {
    ...
    protected ReadableProduct sampleProduct(String code) {
        ...
        specifications.setManufacturer(com.swaraj.core.model.catalog.product.manufacturer.Manufacturer.DEFAULT_MANUFACTURER);
