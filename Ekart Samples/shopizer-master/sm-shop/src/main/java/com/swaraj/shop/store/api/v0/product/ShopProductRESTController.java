package com.swaraj.shop.store.api.v0.product;
...
import com.swaraj.shop.model.catalog.product.PersistableProduct;
import com.swaraj.shop.model.catalog.product.PersistableProductReview;
import com.swaraj.shop.model.catalog.product.ProductPriceEntity;
import com.swaraj.shop.model.catalog.product.ReadableProduct;
import com.swaraj.shop.model.catalog.product.ReadableProductList;
...
import com.swaraj.shop.populator.catalog.PersistableProductOptionPopulator;
import com.swaraj.shop.populator.catalog.PersistableProductOptionValuePopulator;
import com.swaraj.shop.populator.catalog.PersistableProductReviewPopulator;
import com.swaraj.shop.populator.catalog.ReadableProductPopulator;
import com.swaraj.shop.populator.manufacturer.PersistableManufacturerPopulator;
import com.swaraj.shop.store.controller.product.facade.ProductFacade;
import com.swaraj.shop.store.model.filter.QueryFilter;
import com.swaraj.shop.store.model.filter.QueryFilterType;
...
public class ShopProductRESTController {
	...
	public PersistableManufacturer createManufacturer(@PathVariable final String store, @Valid @RequestBody PersistableManufacturer manufacturer, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.swaraj.core.model.catalog.product.manufacturer.Manufacturer manuf = new com.swaraj.core.model.catalog.product.manufacturer.Manufacturer();
	...
	public PersistableProductOptionValue createProductOptionValue(@PathVariable final String store, @Valid @RequestBody PersistableProductOptionValue optionValue, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.swaraj.core.model.catalog.product.attribute.ProductOptionValue optValue = new com.swaraj.core.model.catalog.product.attribute.ProductOptionValue();
	...
	public PersistableProductOption createProductOption(@PathVariable final String store, @Valid @RequestBody PersistableProductOption option, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.swaraj.core.model.catalog.product.attribute.ProductOption opt = new com.swaraj.core.model.catalog.product.attribute.ProductOption();
	...
	public PersistableProductReview createProductReview(@PathVariable final String store, @Valid @RequestBody PersistableProductReview review, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.swaraj.core.model.catalog.product.review.ProductReview rev = new com.swaraj.core.model.catalog.product.review.ProductReview();
...
/*	*//**
	...
	private ReadableProductList getProducts(final int start, final int max, final String store, final String language, final String category, final List<QueryFilter> filters, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			com.swaraj.core.model.catalog.product.ProductList products = productService.listByStore(merchantStore, lang, productCriteria);
