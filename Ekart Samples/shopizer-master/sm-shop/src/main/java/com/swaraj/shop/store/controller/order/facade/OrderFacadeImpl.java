...
import com.swaraj.shop.model.order.OrderEntity;
...
import com.swaraj.shop.populator.customer.PersistableCustomerPopulator;
import com.swaraj.shop.populator.order.OrderProductPopulator;
import com.swaraj.shop.populator.order.PersistableOrderApiPopulator;
import com.swaraj.shop.populator.order.ReadableOrderPopulator;
import com.swaraj.shop.populator.order.ReadableOrderProductPopulator;
import com.swaraj.shop.populator.order.ShoppingCartItemPopulator;
import com.swaraj.shop.populator.order.transaction.PersistablePaymentPopulator;
import com.swaraj.shop.populator.order.transaction.ReadableTransactionPopulator;
...
import com.swaraj.shop.store.controller.customer.facade.CustomerFacade;
import com.swaraj.shop.store.controller.order.facade.OrderFacade;
import com.swaraj.shop.store.controller.shoppingCart.facade.ShoppingCartFacade;
...
import com.swaraj.core.business.services.payments.TransactionService;
...
import com.swaraj.core.business.services.shipping.ShippingQuoteService;
import com.swaraj.core.business.services.shipping.ShippingService;
import com.swaraj.core.business.services.shoppingcart.ShoppingCartService;
import com.swaraj.core.business.utils.CoreConfiguration;
...
import com.swaraj.core.model.payments.CreditCardPayment;
...
public class OrderFacadeImpl implements OrderFacade {
	...
	public OrderTotalSummary calculateOrderTotal(MerchantStore store,
			com.swaraj.shop.model.order.v0.PersistableOrder order, Language language) throws Exception {
	...
	private void setOrderTotals(OrderEntity order, OrderTotalSummary summary) {
		...
		List<com.swaraj.core.model.order.OrderTotal> orderTotals = summary.getTotals();
		for (com.swaraj.core.model.order.OrderTotal t : orderTotals) {
	...
	private Order processOrderModel(ShopOrder order, Customer customer, Transaction transaction, MerchantStore store,
		...
		try {
			...
			List<com.swaraj.core.model.order.OrderTotal> totals = summary.getTotals();

			// re-order totals
			Collections.sort(totals, new Comparator<com.swaraj.core.model.order.OrderTotal>() {
				public int compare(com.swaraj.core.model.order.OrderTotal x,
						com.swaraj.core.model.order.OrderTotal y) {
			...
			Set<com.swaraj.core.model.order.OrderTotal> modelTotals = new LinkedHashSet<com.swaraj.core.model.order.OrderTotal>();
			for (com.swaraj.core.model.order.OrderTotal total : totals) {
			...
			if (PaymentType.PAYPAL.name().equals(paymentType)) {
				...
				payment = new com.swaraj.core.model.payments.PaypalPayment();

				((com.swaraj.core.model.payments.PaypalPayment) payment)
	...
	@Override
	public com.swaraj.shop.model.order.v0.ReadableOrderList getReadableOrderList(MerchantStore store,
	...
	@Override
	public com.swaraj.shop.model.order.v0.ReadableOrderList getReadableOrderList(OrderCriteria criteria,
			MerchantStore store) {
		...
		try {
			...
			com.swaraj.shop.model.order.v0.ReadableOrderList returnList = new com.swaraj.shop.model.order.v0.ReadableOrderList();
			...
			List<com.swaraj.shop.model.order.v0.ReadableOrder> readableOrders = new ArrayList<com.swaraj.shop.model.order.v0.ReadableOrder>();
			for (Order order : orders) {
				com.swaraj.shop.model.order.v0.ReadableOrder readableOrder = new com.swaraj.shop.model.order.v0.ReadableOrder();
	...
	public ShippingQuote getShippingQuote(Customer customer, ShoppingCart cart,
			com.swaraj.shop.model.order.v0.PersistableOrder order, MerchantStore store, Language language)
			throws Exception {
		// create shipping products
		List<ShippingProduct> shippingProducts = shoppingCartService.createShippingProduct(cart);
	...
	private com.swaraj.shop.model.order.v0.ReadableOrderList populateOrderList(final OrderList orderList,
	...
	private void setOrderProductList(final Order order, final Locale locale, final MerchantStore store,
			final Language language, final com.swaraj.shop.model.order.v0.ReadableOrder readableOrder)
	...
	private com.swaraj.shop.model.order.v0.ReadableOrderList getReadableOrderList(OrderCriteria criteria,
			MerchantStore store, Language language) throws Exception {
	...
	@Override
	public com.swaraj.shop.model.order.v0.ReadableOrderList getReadableOrderList(MerchantStore store, int start,
	...
	@Override
	public com.swaraj.shop.model.order.v0.ReadableOrder getReadableOrder(Long orderId, MerchantStore store,
			Language language) {
	 ...
	 */
	@Override
	public Order processOrder(com.swaraj.shop.model.order.v1.PersistableOrder order, Customer customer,
		...
		try {
			...
			if (order.getAttributes() != null && order.getAttributes().size() > 0) {
				...
				for (com.swaraj.shop.model.order.OrderAttribute attribute : order.getAttributes()) {
			...
			List<com.swaraj.core.model.order.OrderTotal> totals = orderTotalSummary.getTotals();
			Set<com.swaraj.core.model.order.OrderTotal> set = new HashSet<com.swaraj.core.model.order.OrderTotal>();
	...
	@Override
	public com.swaraj.shop.model.order.v0.ReadableOrderList getCapturableOrderList(MerchantStore store,
