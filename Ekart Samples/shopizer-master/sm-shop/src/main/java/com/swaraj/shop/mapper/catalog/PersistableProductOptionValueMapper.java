...
import com.swaraj.shop.model.catalog.product.attribute.api.PersistableProductOptionValueEntity;
...
public class PersistableProductOptionValueMapper
	...
	ProductOptionValueDescription description(
			com.swaraj.shop.model.catalog.product.attribute.ProductOptionValueDescription description)
			throws Exception {
	...
	public ProductOptionValue merge(PersistableProductOptionValue source, ProductOptionValue destination,
		...
		try {
			...
			if (!CollectionUtils.isEmpty(source.getDescriptions())) {
				for (com.swaraj.shop.model.catalog.product.attribute.ProductOptionValueDescription desc : source
						.getDescriptions()) {
