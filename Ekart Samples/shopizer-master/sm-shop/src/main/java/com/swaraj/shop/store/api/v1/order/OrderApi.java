package com.swaraj.shop.store.api.v1.order;
...
import com.swaraj.shop.model.order.v0.ReadableOrderList;
...
import com.swaraj.shop.store.security.services.CredentialsException;
import com.swaraj.shop.store.security.services.CredentialsService;
import com.swaraj.shop.utils.AuthorizationUtils;
...
public class OrderApi {
	...
	@Inject
	private com.swaraj.shop.store.controller.order.facade.v1.OrderFacade orderFacadeV1;
	...
	public ReadableOrderConfirmation checkout(
		...
		try {
			...
			if(StringUtils.isBlank(message)) {//exception type
				message = "APP-BACKEND";
				if(e.getCause() instanceof com.swaraj.core.modules.integration.IntegrationException) {
