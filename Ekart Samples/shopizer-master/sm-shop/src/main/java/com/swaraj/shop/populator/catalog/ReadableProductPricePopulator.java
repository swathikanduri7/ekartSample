...
import com.swaraj.shop.model.catalog.product.ReadableProductPriceFull;
...
public class ReadableProductPricePopulator extends
	...
	public ReadableProductPrice populate(ProductPrice source,
		...
		try {
		    ...
		    if(source.getDescriptions()!=null && source.getDescriptions().size()>0) {
		       List<com.swaraj.shop.model.catalog.product.ProductPriceDescription> fulldescriptions = new ArrayList<com.swaraj.shop.model.catalog.product.ProductPriceDescription>();
               ...
               if (description != null) {
                   com.swaraj.shop.model.catalog.product.ProductPriceDescription d = populateDescription(description);
	...
	com.swaraj.shop.model.catalog.product.ProductPriceDescription populateDescription(
	      ProductPriceDescription description) {
	    if (description == null) {
	      return null;
	    }
	    com.swaraj.shop.model.catalog.product.ProductPriceDescription d =
	        new com.swaraj.shop.model.catalog.product.ProductPriceDescription();
