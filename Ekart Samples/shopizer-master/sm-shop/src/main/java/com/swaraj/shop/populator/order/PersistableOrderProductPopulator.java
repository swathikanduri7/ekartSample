...
import com.swaraj.shop.model.catalog.product.attribute.ProductAttribute;
...
/*			//Other prices
			...
			if(!CollectionUtils.isEmpty(attributeItems)) {
				...
				for(ProductAttribute attribute : attributeItems) {
					...
					com.swaraj.core.model.catalog.product.attribute.ProductAttribute attr = productAttributeService.getById(id);
					if(attr==null) {
