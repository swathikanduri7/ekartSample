package com.swaraj.shop.store.facade.category;
...
import com.swaraj.shop.model.catalog.category.PersistableCategory;
import com.swaraj.shop.model.catalog.category.ReadableCategory;
import com.swaraj.shop.model.catalog.category.ReadableCategoryList;
import com.swaraj.shop.model.catalog.product.attribute.ReadableProductVariant;
import com.swaraj.shop.model.catalog.product.attribute.ReadableProductVariantValue;
import com.swaraj.shop.model.entity.ListCriteria;
import com.swaraj.shop.populator.catalog.PersistableCategoryPopulator;
import com.swaraj.shop.populator.catalog.ReadableCategoryPopulator;
...
import com.swaraj.shop.store.api.exception.UnauthorizedException;
import com.swaraj.shop.store.controller.category.facade.CategoryFacade;
...
/*		if (!CollectionUtils.isEmpty(children)) {
	...
	public List<ReadableProductVariant> categoryProductVariants(Long categoryId, MerchantStore store,
		...
		try {
			 ...
			 **/
			Map<String, List<com.swaraj.shop.model.catalog.product.attribute.ProductOptionValue>> rawFacet = new HashMap<String, List<com.swaraj.shop.model.catalog.product.attribute.ProductOptionValue>>();
			...
			for (ProductAttribute attr : attributes) {
				...
				List<com.swaraj.shop.model.catalog.product.attribute.ProductOptionValue> values = rawFacet.get(attr.getProductOption().getCode());
				if (values == null) {
					values = new ArrayList<com.swaraj.shop.model.catalog.product.attribute.ProductOptionValue>();
				...
				if(attr.getProductOptionValue() != null) {
					...
					com.swaraj.shop.model.catalog.product.attribute.ProductOptionValue val = new com.swaraj.shop.model.catalog.product.attribute.ProductOptionValue();
			...
			while (it.hasNext()) {
				...
				List<com.swaraj.shop.model.catalog.product.attribute.ProductOptionValue> values = rawFacet.get(option.getCode());
				...
				if(optionDescription.isPresent()) {
					...
					for (com.swaraj.shop.model.catalog.product.attribute.ProductOptionValue value : values) {
