package com.swaraj.shop.admin.security;
...
public class UserServicesImpl implements WebUserServices{
	...
	public UserDetails loadUserByUsername(String userName)
		...
		com.swaraj.core.model.user.User user = null;
	...
	public void createDefaultAdmin() throws Exception {
		  ...
		  com.swaraj.core.model.user.User user = new com.swaraj.core.model.user.User("admin@shopizer.com",password,"admin@shopizer.com");
