package com.swaraj.shop.admin.controller.categories;
...
public class CategoryController {
    ...
    private String displayCategory(Long categoryId, Model model, HttpServletRequest request) throws Exception {
        ...
        com.swaraj.shop.admin.model.catalog.Category adminCategory = new com.swaraj.shop.admin.model.catalog.Category();
    ...
    public String saveCategory(@Valid @ModelAttribute("category") com.swaraj.shop.admin.model.catalog.Category category, BindingResult result, Model model, HttpServletRequest request) throws Exception {
