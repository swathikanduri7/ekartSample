...
import com.swaraj.core.model.catalog.product.price.ProductPriceType;
...
public class ProductPriceController {
	...
	private String displayProductPrice(Product product, Long productPriceId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.swaraj.shop.admin.model.catalog.ProductPrice pprice = new com.swaraj.shop.admin.model.catalog.ProductPrice();
		...
		if(productPriceId!=null) {
			...
			//get default availability
			for(ProductAvailability availability : availabilities) {
				if(availability.getRegion().equals(com.swaraj.core.business.constants.Constants.ALL_REGIONS)) {//TODO to be updated when multiple regions is implemented
					productAvailability = availability;
	...
	public String saveProductPrice(@Valid @ModelAttribute("price") com.swaraj.shop.admin.model.catalog.ProductPrice price, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
