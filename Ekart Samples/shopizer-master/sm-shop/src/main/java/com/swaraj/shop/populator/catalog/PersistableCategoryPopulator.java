...
import com.swaraj.shop.model.catalog.category.CategoryDescription;
...
/*		Validate.notNull(categoryService, "Requires to set CategoryService");
		...
		if(!CollectionUtils.isEmpty(source.getDescriptions())) {
			Set<com.swaraj.core.model.catalog.category.CategoryDescription> descriptions = new HashSet<com.swaraj.core.model.catalog.category.CategoryDescription>();
			if(CollectionUtils.isNotEmpty(target.getDescriptions())) {
    			for(com.swaraj.core.model.catalog.category.CategoryDescription description : target.getDescriptions()) {
			  ...
			  for(CategoryDescription d : source.getDescriptions()) {
                com.swaraj.core.model.catalog.category.CategoryDescription t = new com.swaraj.core.model.catalog.category.CategoryDescription();
	...
	private com.swaraj.core.model.catalog.category.CategoryDescription buildDescription(com.swaraj.shop.model.catalog.category.CategoryDescription source, com.swaraj.core.model.catalog.category.CategoryDescription target) throws Exception {
      //com.swaraj.core.model.catalog.category.CategoryDescription desc = new com.swaraj.core.model.catalog.category.CategoryDescription();
