package com.swaraj.shop.store.facade.items;
...
import com.swaraj.shop.model.catalog.product.group.ProductGroup;
...
import com.swaraj.shop.store.controller.items.facade.ProductItemsFacade;
...
public class ProductItemsFacadeImpl implements ProductItemsFacade {
	...
	public ReadableProductList listItemsByManufacturer(MerchantStore store,
		...
		com.swaraj.core.model.catalog.product.ProductList products = productService.listByStore(store, language, productCriteria);
