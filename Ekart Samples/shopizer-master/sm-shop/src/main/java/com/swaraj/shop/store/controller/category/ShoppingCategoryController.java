package com.swaraj.shop.store.controller.category;
...
import com.swaraj.shop.model.catalog.ProductList;
...
import com.swaraj.shop.model.shop.Breadcrumb;
import com.swaraj.shop.model.shop.PageInformation;
...
import com.swaraj.shop.populator.manufacturer.ReadableManufacturerPopulator;
...
import com.swaraj.shop.utils.BreadcrumbsUtils;
import com.swaraj.shop.utils.ImageFilePath;
import com.swaraj.shop.utils.PageBuilderUtils;
import com.swaraj.shop.utils.SanitizeUtils;
...
public class ShoppingCategoryController {
	...
	private List<ReadableManufacturer> getManufacturers(MerchantStore store, List<Long> ids, Language language) throws Exception {
		...
		List<com.swaraj.core.model.catalog.product.manufacturer.Manufacturer> manufacturers = manufacturerService.listByProductsByCategoriesId(store, ids, language);
		if(!manufacturers.isEmpty()) {
			
			for(com.swaraj.core.model.catalog.product.manufacturer.Manufacturer manufacturer : manufacturers) {
	...
	public ProductList getProducts(@PathVariable final String store, @PathVariable final String language, @PathVariable final String category, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			List<com.swaraj.core.model.catalog.product.Product> products = productService.getProducts(ids, lang);
