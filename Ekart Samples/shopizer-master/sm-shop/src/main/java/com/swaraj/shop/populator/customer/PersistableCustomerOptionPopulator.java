...
import com.swaraj.shop.model.customer.attribute.CustomerOptionDescription;
	...
	public CustomerOption populate(PersistableCustomerOption source,
		...
		try {
			...
			if(!CollectionUtils.isEmpty(source.getDescriptions())) {
				Set<com.swaraj.core.model.customer.attribute.CustomerOptionDescription> descriptions = new HashSet<com.swaraj.core.model.customer.attribute.CustomerOptionDescription>();
				for(CustomerOptionDescription desc  : source.getDescriptions()) {
					com.swaraj.core.model.customer.attribute.CustomerOptionDescription description = new com.swaraj.core.model.customer.attribute.CustomerOptionDescription();
