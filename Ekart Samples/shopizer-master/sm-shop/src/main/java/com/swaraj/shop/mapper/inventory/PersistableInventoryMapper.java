package com.swaraj.shop.mapper.inventory;

import static com.swaraj.core.business.utils.NumberUtils.isPositive;
...
//              .filter()
  ...
  private Set<ProductPriceDescription> getProductPriceDescriptions(ProductPrice price, List<com.swaraj.shop.model.catalog.product.ProductPriceDescription> descriptions) throws ConversionException {
    if (CollectionUtils.isEmpty(descriptions)) {
      return Collections.emptySet();
    }
    Set<ProductPriceDescription> descs = new HashSet<ProductPriceDescription>();
    for(com.swaraj.shop.model.catalog.product.ProductPriceDescription desc : descriptions) {
  ...
  private ProductPriceDescription getDescription(com.swaraj.shop.model.catalog.product.ProductPriceDescription desc) throws ConversionException {
  ...
  private Language getLanguage(com.swaraj.shop.model.catalog.product.ProductPriceDescription desc) throws ConversionException {
    try {
