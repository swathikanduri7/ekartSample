...
import com.swaraj.shop.admin.controller.customers.CustomerController;
...
public class ManufacturerController {
	...
	private String displayManufacturer(Long manufacturerId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.swaraj.shop.admin.model.catalog.Manufacturer manufacturer = new com.swaraj.shop.admin.model.catalog.Manufacturer();
	...
	public String saveManufacturer( @Valid @ModelAttribute("manufacturer") com.swaraj.shop.admin.model.catalog.Manufacturer manufacturer, BindingResult result, Model model,  HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
