package com.swaraj.shop.filter;
...
import com.swaraj.shop.model.shop.BreadcrumbItem;
import com.swaraj.shop.model.shop.BreadcrumbItemType;
...
import com.swaraj.shop.utils.GeoLocationUtils;
import com.swaraj.shop.utils.LabelUtils;
import com.swaraj.shop.utils.LanguageUtils;
import com.swaraj.shop.utils.WebApplicationCacheUtils;
...
import com.swaraj.core.model.common.UserContext;
			...
			if (anonymousCustomer == null) {
				...
				try {
					...
					if(!StringUtils.isBlank(ipAddress)) {
						com.swaraj.core.model.common.Address geoAddress = customerService.getCustomerAddress(store,
								ipAddress);
						if (geoAddress != null) {
							address = new Address();
