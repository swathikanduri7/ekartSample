...
import com.swaraj.core.business.modules.integration.payment.impl.PayPalExpressCheckoutPayment;
import com.swaraj.core.business.modules.integration.payment.impl.Stripe3Payment;
...
import com.swaraj.core.model.payments.PaypalPayment;
...
public class ShoppingOrderPaymentController extends AbstractController {
	...
	public @ResponseBody String paymentAction(@Valid @ModelAttribute(value = "order") ShopOrder order,
		...
		try {
			...
			com.swaraj.core.model.shoppingcart.ShoppingCart cart = shoppingCartFacade
				...
				if (paymentmethod.equals("PAYPAL")) {
					try {
						...
						if (config.getEnvironment()
								.equals(com.swaraj.core.business.constants.Constants.PRODUCTION_ENVIRONMENT)) {
