...
import com.swaraj.shop.mapper.catalog.PersistableProductAttributeMapper;
	...
	public Product populate(PersistableProduct source,
		...
		try {
			...
			if(source.getOwner()!=null && source.getOwner().getId()!=null) {
				com.swaraj.core.model.customer.Customer owner = customerService.getById(source.getOwner().getId());
			...
			if(!CollectionUtils.isEmpty(source.getDescriptions())) {
				for(com.swaraj.shop.model.catalog.product.ProductDescription description : source.getDescriptions()) {
			...
			if(CollectionUtils.isNotEmpty(source.getProductPrices())) {
				...
				for(com.swaraj.shop.model.catalog.product.PersistableProductPrice priceEntity : source.getProductPrices()) {
					...
					for(Language lang : languages) {
						...
						//price appender
						Optional<com.swaraj.shop.model.catalog.product.ProductPriceDescription> description = priceEntity.getDescriptions().stream().filter(d -> d.getLanguage()!= null && d.getLanguage().equals(lang.getCode())).findFirst();
			...
			if(source.getAttributes()!=null) {
				for(com.swaraj.shop.model.catalog.product.attribute.PersistableProductAttribute attr : source.getAttributes()) {
			...
			if(!CollectionUtils.isEmpty(source.getCategories())) {
				for(com.swaraj.shop.model.catalog.category.Category categ : source.getCategories()) {
