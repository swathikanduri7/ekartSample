package com.swaraj.shop.store.controller.order;
...
import com.swaraj.core.business.services.order.orderproduct.OrderProductDownloadService;
import com.swaraj.shop.admin.model.userpassword.UserReset;
import com.swaraj.shop.constants.Constants;
import com.swaraj.shop.model.customer.AnonymousCustomer;
import com.swaraj.shop.model.customer.PersistableCustomer;
import com.swaraj.shop.model.customer.ReadableDelivery;
import com.swaraj.shop.model.order.ReadableShopOrder;
import com.swaraj.shop.model.order.ShopOrder;
import com.swaraj.shop.model.order.shipping.ReadableShippingSummary;
import com.swaraj.shop.model.order.total.ReadableOrderTotal;
import com.swaraj.shop.model.shoppingcart.ShoppingCartData;
import com.swaraj.shop.populator.customer.ReadableCustomerDeliveryAddressPopulator;
import com.swaraj.shop.populator.order.ReadableOrderTotalPopulator;
import com.swaraj.shop.populator.order.ReadableShippingSummaryPopulator;
import com.swaraj.shop.populator.order.ReadableShopOrderPopulator;
...
import com.swaraj.core.model.shipping.ShippingMetaData;
...
public class ShoppingOrderController extends AbstractController {
	...
	public String displayCheckout(@CookieValue("cart") String cookie, Model model, HttpServletRequest request, HttpServletResponse response, Locale locale) throws Exception {
		...
		com.swaraj.core.model.shoppingcart.ShoppingCart cart = null;
        ...
        Set<com.swaraj.core.model.shoppingcart.ShoppingCartItem> availables = new HashSet<ShoppingCartItem>();
	...
	if(cart == null) {
        ...
        Set<com.swaraj.core.model.shoppingcart.ShoppingCartItem> items = cart.getLineItems();
        for(com.swaraj.core.model.shoppingcart.ShoppingCartItem item : items) {
...
/*		if(configs!=null && configs.containsKey(Constants.DEBUG_MODE)) {
		...
		try {
			...
			//re-generate cart
			com.swaraj.core.model.shoppingcart.ShoppingCart cart = shoppingCartFacade.getShoppingCartModel(shoppingCartCode, store);
			Set<com.swaraj.core.model.shoppingcart.ShoppingCartItem> cartItems = cart.getLineItems();	
			...
			/**
	        for(com.swaraj.core.model.shoppingcart.ShoppingCartItem item : cartItems) {
