...
public class DocumentationConfiguration {
	...
	final Predicate<RequestHandler> requestHandlers() {
		   ...
		   matchers.add(RequestHandlerSelectors.basePackage("com.swaraj.shop.store.api.v1"));
		   matchers.add(RequestHandlerSelectors.basePackage("com.swaraj.shop.store.api.v2"));
