package com.swaraj.shop.admin.controller.customers;
	...
	public @ResponseBody ResponseEntity<String> saveCustomerAttributes(HttpServletRequest request, Locale locale) throws Exception {
		...
		while(parameterNames.hasMoreElements()) {
			...
			try {
				...
				com.swaraj.core.model.customer.attribute.CustomerOption customerOption = null;
				com.swaraj.core.model.customer.attribute.CustomerOptionValue customerOptionValue = null;
