...
import com.swaraj.shop.model.catalog.category.ReadableCategoryFull;
...
public class ReadableCategoryMapper implements Mapper<Category, ReadableCategory> {
  ...
  public ReadableCategory convert(Category source, MerchantStore store, Language language) {
    ...
    if (Objects.isNull(language)) {
      ...
      List<com.swaraj.shop.model.catalog.category.CategoryDescription> descriptions = source.getDescriptions().stream()
      ...
      Optional<com.swaraj.shop.model.catalog.category.CategoryDescription> description = source.getDescriptions().stream()
  ...
  private void fillReadableCategory(ReadableCategory target, Category source) {
    Optional<com.swaraj.shop.model.catalog.category.Category> parentCategory =
  ...
  private com.swaraj.shop.model.catalog.category.CategoryDescription convertDescription(
      CategoryDescription description) {
    final com.swaraj.shop.model.catalog.category.CategoryDescription desc =
        new com.swaraj.shop.model.catalog.category.CategoryDescription();
  ...
  private Optional<com.swaraj.shop.model.catalog.category.Category> createParentCategory(
      Category source) {
    return Optional.ofNullable(source.getParent()).map(parentValue -> {
      final com.swaraj.shop.model.catalog.category.Category parent =
          new com.swaraj.shop.model.catalog.category.Category();
