package com.swaraj.shop.admin.controller.orders;
...
import com.swaraj.core.business.services.order.orderstatushistory.OrderStatusHistoryService;
...
import com.swaraj.shop.admin.controller.ControllerConstants;
import com.swaraj.shop.admin.model.web.Menu;
...
private static final Logger LOGGER = LoggerFactory.getLogger(OrderControler.class);
	...
	private String displayOrder(Long orderId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.swaraj.shop.admin.model.orders.Order order = new com.swaraj.shop.admin.model.orders.Order();
	...
	public String saveOrder(@Valid @ModelAttribute("order") com.swaraj.shop.admin.model.orders.Order entityOrder, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
		...
		com.swaraj.core.model.order.Order newOrder = orderService.getById(entityOrder.getOrder().getId() );
	...
	private void addStatusUpdatedInfo(com.swaraj.shop.admin.model.orders.Order entityOrder, Customer customer, Locale customerLocale, Map<String, String> templateTokens) {
	...
	private OrderStatusHistory getOrderStatusHistory(com.swaraj.shop.admin.model.orders.Order entityOrder, Locale customerLocale) {
	...
	private void addStatusChangedHistory(com.swaraj.shop.admin.model.orders.Order entityOrder, Locale locale,
