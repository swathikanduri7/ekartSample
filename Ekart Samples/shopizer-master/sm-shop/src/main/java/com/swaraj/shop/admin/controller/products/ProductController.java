package com.swaraj.shop.admin.controller.products;
...
import com.swaraj.core.business.utils.ajax.AjaxPageableResponse;
import com.swaraj.core.business.utils.ajax.AjaxResponse;
...
import com.swaraj.core.model.catalog.product.image.ProductImageDescription;
...
import com.swaraj.shop.utils.CategoryUtils;
...
public class ProductController {
	...
	private String displayProduct(Long productId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		com.swaraj.shop.admin.model.catalog.Product product = new com.swaraj.shop.admin.model.catalog.Product();
		...
		if(productId!=null && productId!=0) {//edit mode
			...
			if(availabilities!=null && availabilities.size()>0) {
				...
				for(ProductAvailability availability : availabilities) {
					if(availability.getRegion().equals(com.swaraj.core.business.constants.Constants.ALL_REGIONS)) {
	...
	public String saveProduct(@Valid @ModelAttribute("product") com.swaraj.shop.admin.model.catalog.Product  product, BindingResult result, Model model, HttpServletRequest request, Locale locale) throws Exception {
	...
	public String displayAddProductToCategories(@RequestParam("id") long productId, Model model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		List<com.swaraj.shop.admin.model.catalog.Category> readableCategories = CategoryUtils.readableCategoryListConverter(categories, language);
