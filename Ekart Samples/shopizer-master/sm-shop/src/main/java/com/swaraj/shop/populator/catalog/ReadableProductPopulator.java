...
import com.swaraj.shop.model.catalog.product.ReadableProductFull;
import com.swaraj.shop.model.catalog.product.ReadableProductPrice;
import com.swaraj.shop.model.catalog.product.RentalOwner;
import com.swaraj.shop.model.catalog.product.attribute.ReadableProductAttribute;
import com.swaraj.shop.model.catalog.product.attribute.ReadableProductAttributeValue;
import com.swaraj.shop.model.catalog.product.attribute.ReadableProductOption;
import com.swaraj.shop.model.catalog.product.attribute.ReadableProductProperty;
import com.swaraj.shop.model.catalog.product.attribute.ReadableProductPropertyValue;
		...
		try {
		   ...
		   final Language lang = language;
			...
			if(source.getOwner() != null) {
				...
				com.swaraj.shop.model.customer.address.Address address = new com.swaraj.shop.model.customer.address.Address();
...
/*			if(source.getProductReviewCount()!=null) {
			...
			if(description!=null) {
			    com.swaraj.shop.model.catalog.product.ProductDescription tragetDescription = populateDescription(description);
			...
			if(source.getManufacturer()!=null) {
				...
				com.swaraj.shop.model.catalog.manufacturer.ManufacturerDescription d = new com.swaraj.shop.model.catalog.manufacturer.ManufacturerDescription();
...
/*								propertyValue.setCode(attribute.getProductOptionValue().getCode());
								...
								com.swaraj.shop.model.catalog.product.attribute.ProductOptionValueDescription valueDescription = new com.swaraj.shop.model.catalog.product.attribute.ProductOptionValueDescription();
...
/*			Set<Category> categories = source.getCategories();
				...
				if(availability != null) {
					...
					if(!CollectionUtils.isEmpty(prices)) {
						...
						if(pr.isPresent()) {
							...
							if(d.isPresent()) {
								com.swaraj.shop.model.catalog.product.ProductPriceDescription priceDescription = new com.swaraj.shop.model.catalog.product.ProductPriceDescription();
	...
	private ProductTypeDescription typeDescription(com.swaraj.core.model.catalog.product.type.ProductTypeDescription description) {
	...
	private ReadableProductProperty createProperty(ProductAttribute productAttribute, Language language) {
		...
		if(descriptions!=null && descriptions.size()>0) {
			for(ProductOptionDescription optionDescription : descriptions) {
				com.swaraj.shop.model.catalog.product.attribute.ProductOptionValueDescription productOptionValueDescription = new com.swaraj.shop.model.catalog.product.attribute.ProductOptionValueDescription();
    ...
    com.swaraj.shop.model.catalog.product.ProductDescription populateDescription(ProductDescription description) {
      if(description == null) {
        return null;
      }
