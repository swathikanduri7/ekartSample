 ...
 *
 */
package com.swaraj.shop.store.controller.shoppingCart.facade;
...
import com.swaraj.shop.model.shoppingcart.CartModificationException;
import com.swaraj.shop.model.shoppingcart.PersistableShoppingCartItem;
import com.swaraj.shop.model.shoppingcart.ReadableShoppingCart;
import com.swaraj.shop.model.shoppingcart.ShoppingCartAttribute;
import com.swaraj.shop.model.shoppingcart.ShoppingCartData;
import com.swaraj.shop.model.shoppingcart.ShoppingCartItem;
import com.swaraj.shop.populator.shoppingCart.ReadableShoppingCartPopulator;
import com.swaraj.shop.populator.shoppingCart.ShoppingCartDataPopulator;
...
import com.swaraj.core.business.services.shoppingcart.ShoppingCartCalculationService;
    ...
    implements ShoppingCartFacade
{
        ...
        throws Exception
    {
        ...
        com.swaraj.core.model.shoppingcart.ShoppingCartItem shoppingCartItem =
        ...
        if(CollectionUtils.isEmpty(item.getShoppingCartAttributes())) {//increment quantity
        	...
        	Set<com.swaraj.core.model.shoppingcart.ShoppingCartItem> cartModelItems = cartModel.getLineItems();
        	for(com.swaraj.core.model.shoppingcart.ShoppingCartItem cartItem : cartModelItems) {
    ...
    private com.swaraj.core.model.shoppingcart.ShoppingCartItem createCartItem( final ShoppingCart cartModel,
        ...
        throws Exception
    {
        ...
        com.swaraj.core.model.shoppingcart.ShoppingCartItem item =
        ...
        if ( !CollectionUtils.isEmpty( cartAttributes ) )
        {
            for ( ShoppingCartAttribute attribute : cartAttributes )
            {
                ...
                {
                    com.swaraj.core.model.shoppingcart.ShoppingCartAttributeItem attributeItem =
                        new com.swaraj.core.model.shoppingcart.ShoppingCartAttributeItem( item,
                                                                                                         productAttribute );
    ...
    //used for api
	private com.swaraj.core.model.shoppingcart.ShoppingCartItem createCartItem(ShoppingCart cartModel,
		...
		com.swaraj.core.model.shoppingcart.ShoppingCartItem item = shoppingCartService
		...
		//set attributes
		List<com.swaraj.shop.model.catalog.product.attribute.ProductAttribute> attributes = shoppingCartItem.getAttributes();
		if (!CollectionUtils.isEmpty(attributes)) {
			for(com.swaraj.shop.model.catalog.product.attribute.ProductAttribute attribute : attributes) {
				...
				if (productAttribute != null
					...
					com.swaraj.core.model.shoppingcart.ShoppingCartAttributeItem attributeItem = new com.swaraj.core.model.shoppingcart.ShoppingCartAttributeItem(
    ...
    //used for api
    private List<com.swaraj.core.model.shoppingcart.ShoppingCartItem> createCartItems(ShoppingCart cartModel,
        ...
        List<com.swaraj.core.model.shoppingcart.ShoppingCartItem> items = new ArrayList<>();

        for (Product p: products) {
            com.swaraj.core.model.shoppingcart.ShoppingCartItem item = shoppingCartService.populateShoppingCartItem(p);
    ...
    private com.swaraj.core.model.shoppingcart.ShoppingCartItem getEntryToUpdate( final long entryId,
                                                                                                 final ShoppingCart cartModel )
    {
        if ( CollectionUtils.isNotEmpty( cartModel.getLineItems() ) )
        {
            for ( com.swaraj.core.model.shoppingcart.ShoppingCartItem shoppingCartItem : cartModel.getLineItems() )
            {
...
/*        List<ShoppingCartItem> unavailables = new ArrayList<ShoppingCartItem>();
        ...
        throws Exception
    {
        if ( StringUtils.isNotBlank( cartId ) )
        {
            ...
            if ( cartModel != null )
            {
                if ( CollectionUtils.isNotEmpty( cartModel.getLineItems() ) )
                {
                    Set<com.swaraj.core.model.shoppingcart.ShoppingCartItem> shoppingCartItemSet =
                        new HashSet<com.swaraj.core.model.shoppingcart.ShoppingCartItem>();
                    for ( com.swaraj.core.model.shoppingcart.ShoppingCartItem shoppingCartItem : cartModel.getLineItems() )
                    {
        ...
        throws Exception
    {
        ...
        if ( StringUtils.isNotBlank( cartId ) )
        {
            ...
            if ( cartModel != null )
            {
                com.swaraj.core.model.shoppingcart.ShoppingCartItem entryToUpdate =
    ...
    public ShoppingCartData updateCartItems( Optional<String> promoCode, final List<ShoppingCartItem> shoppingCartItems, final MerchantStore store, final Language language )
            throws Exception
        {
    		...
    		ShoppingCart cartModel = null;
    		Set<com.swaraj.core.model.shoppingcart.ShoppingCartItem> cartItems = new HashSet<com.swaraj.core.model.shoppingcart.ShoppingCartItem>();
	...
	public @Nullable ReadableShoppingCart removeShoppingCartItem(String cartCode, Long productId,
	    ...
	    Set<com.swaraj.core.model.shoppingcart.ShoppingCartItem> items = new HashSet<com.swaraj.core.model.shoppingcart.ShoppingCartItem>();
	    com.swaraj.core.model.shoppingcart.ShoppingCartItem itemToDelete = null;
	    for ( com.swaraj.core.model.shoppingcart.ShoppingCartItem shoppingCartItem : cart.getLineItems() )
        {
	...
	private ReadableShoppingCart readableShoppingCart(ShoppingCart cartModel, PersistableShoppingCartItem item, MerchantStore store,
		...
		com.swaraj.core.model.shoppingcart.ShoppingCartItem itemModel = createCartItem(cartModel, item, store);
	...
	private ReadableShoppingCart modifyCart(ShoppingCart cartModel, PersistableShoppingCartItem item, MerchantStore store,
        ...
        //check if existing product
       	Set<com.swaraj.core.model.shoppingcart.ShoppingCartItem> items = cartModel.getLineItems();
       	if(!CollectionUtils.isEmpty(items)) {
       		Set<com.swaraj.core.model.shoppingcart.ShoppingCartItem> newItems = new HashSet<com.swaraj.core.model.shoppingcart.ShoppingCartItem>();
       		Set<com.swaraj.core.model.shoppingcart.ShoppingCartItem> removeItems = new HashSet<com.swaraj.core.model.shoppingcart.ShoppingCartItem>();
	    	for(com.swaraj.core.model.shoppingcart.ShoppingCartItem anItem : items) {//take care of existing product
	    	...
	    	if(!removeItems.isEmpty()) {
	    		for(com.swaraj.core.model.shoppingcart.ShoppingCartItem emptyItem : removeItems) {
    ...
    private ReadableShoppingCart modifyCartMulti(ShoppingCart cartModel, List<PersistableShoppingCartItem> cartItems, MerchantStore store,
        ...
        List<com.swaraj.core.model.shoppingcart.ShoppingCartItem> inCartItemList = createCartItems(cartModel, cartItems, store);

        int itemUpdatedCnt = 0;

        Set<com.swaraj.core.model.shoppingcart.ShoppingCartItem> existingItems = cartModel.getLineItems();
        // loop over incoming items since they drive changes
        for (com.swaraj.core.model.shoppingcart.ShoppingCartItem newItemValue : inCartItemList) {

            // check that item exist in persisted cart
            Optional<com.swaraj.core.model.shoppingcart.ShoppingCartItem> oOldItem =
            ...
            if (oOldItem.isPresent()) {
                ...
                com.swaraj.core.model.shoppingcart.ShoppingCartItem oldCartItem = oOldItem.get();
