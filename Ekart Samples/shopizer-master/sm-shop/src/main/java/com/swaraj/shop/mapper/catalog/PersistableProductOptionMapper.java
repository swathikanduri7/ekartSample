...
public class PersistableProductOptionMapper implements Mapper<PersistableProductOptionEntity, ProductOption> {
  ...
  ProductOptionDescription description(com.swaraj.shop.model.catalog.product.attribute.ProductOptionDescription description) throws Exception {
  ...
  public ProductOption merge(PersistableProductOptionEntity source, ProductOption destination,
    ...
    try {
      ...
      if(!CollectionUtils.isEmpty(source.getDescriptions())) {
        for(com.swaraj.shop.model.catalog.product.attribute.ProductOptionDescription desc : source.getDescriptions()) {
